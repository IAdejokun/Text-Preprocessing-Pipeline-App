...
const SignupComponent = lazy(() => import("../auth/signup/signup-view"));
const SigninComponent = lazy(() => import("../auth/signin/signin-view"));
...
const AllRoutesComponent = () => {
  return (
    <Suspense fallback={<SkeletonLoader />}>
      <BrowserRouter>
        <Routes>
          <Route path={rootpath} element={<Navigate to={signinpath} replace />} />
